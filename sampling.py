...
def get_dataset_mnist_extr_noniid(num_users, n_class, nsamples, rate_unbalance, rand_seed = 0, all_class = False, all_class_prop = 0.05):
    data_dir = '../data/mnist/'
    apply_transform = transforms.Compose(
        [transforms.ToTensor(),
    ...
    # Chose euqal splits for every user
    user_groups_train, user_groups_test = mnist_extr_noniid(train_dataset, test_dataset, num_users, n_class, nsamples, rate_unbalance,rand_seed,  all_class = all_class, all_class_prop = all_class_prop)
    return train_dataset, test_dataset, user_groups_train, user_groups_test

def mnist_extr_noniid(train_dataset, test_dataset, num_users, n_class, num_samples, rate_unbalance, rand_seed = 0, all_class = False, all_class_prop = 0.05):
